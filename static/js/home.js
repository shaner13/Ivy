...
//Map widget - handle user location
const map = new mapboxgl.Map({
    container: 'map', // container ID
    style: 'mapbox://styles/shaner13/ckwuulbsj32fh14pb195g39y2',
    center: [-6.284179687500001, 53.31774904749089],
    zoom: 1, // starting zoom
    maxBounds: bounds
});

// Functions for map pin and getting address
const marker = new mapboxgl.Marker({
        draggable: true,
        color: 'green',
})
.setLngLat([ -6.241, 53.428 ])
.addTo(map);
...
async function getAddressString(coords) {
    ...
    .concat('.json?access_token=').concat(mapboxgl.accessToken));
